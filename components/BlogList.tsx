            ...
            <div key={post._id} className="group cursor-pointer flex flex-col">
              <div className="relative w-full h-80 drop-shadow-xl group-hover:scale-105 transition-transform duration-200 ease-out">
                <Image
                  ...
                  fill
                ></Image>
                <div className="absolute bottom-0 w-full bg-opacity-20 bg-black backdrop-blur-lg rounded drop-shadow-lg text-white p-5 flex flex-col md:flex-row justify-between">
                  <div>
              ...
              <p className="mt-3 group-hover:underline font-bold flex items-center">
                Read Post
